...
WORKOUTS: dict[str, dict[str, Any]] = {
    ...
    "parkrun_5k": _distance_run("Parkrun 5K — time trial", 5000, step_name="Race effort"),
    ...
    "speed_pyramid": {
        "name": "Speed double pyramid — 2x(200-400-600-400-200)",
        "kind": "run",
        "sport_type": 100,
        "intensity_type": 0,
        "steps": [
            ...
            },
            {
                ...
                "steps": [
                    {
                        "kind": "training",
                        "name": "200m @ 4:10–4:20/km",
                        "target_type": "distance",
                        "target_distance_meters": 200,
                        **_pace_target(4, 10, 4, 20),
                    },
                    {
                        "kind": "rest",
                        "name": "Walk recovery ~90s",
                    ...
                    {
                        "kind": "training",
                        "name": "400m @ 4:20–4:30/km",
                        "target_type": "distance",
                        "target_distance_meters": 400,
                        **_pace_target(4, 20, 4, 30),
                    },
                    {
                        "kind": "rest",
                        "name": "Walk recovery ~90s",
